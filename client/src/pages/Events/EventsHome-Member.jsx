		...
		<div className="container">
			...
			<div>
				<p className="instruction">
					{" "}
					Please take note that you can only submit the form if you have completed all the requirements. Otherwise, your
				...
				<div className="col-md-5 mx-auto">
					...
					<div className="row align-items-center mt-3">
						...
						<div className="col-md-8">
							<input type="text" className="form-control" value="2023 - A" readOnly />
						</div>
					</div>
					<div className="row align-items-center mt-3">
						<div className="col-md-4">
						...
						<div className="col-md-8">
							<input type="text" className="form-control" value="Meeting 1" readOnly />
						</div>
					</div>
					<div className="row align-items-center mt-3">
						<div className="col-md-4">
						...
						<div className="col-md-8">
							<input type="text" className="form-control" value="01/01/23" readOnly />
						</div>
					</div>
					<div className="row align-items-center mt-3">
						<div className="col-md-4">
						...
						<div className="col-md-8">
							<input type="text" className="form-control" value="Junior Deacon" readOnly />
						</div>
					</div>
					<div className="row align-items-center mt-3">
						<div className="col-md-4">
						...
						<div className="col-md-8">
							<input type="text" className="form-control" value="Beginner" readOnly />
						</div>
					</div>
					<div className="row align-items-center mt-3">
						<div className="col-md-4">

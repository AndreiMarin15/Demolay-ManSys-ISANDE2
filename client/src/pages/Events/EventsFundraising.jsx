...
function EventsFundraising() {
  ...
  useEffect(() => {
    ...
    setEventsData(prevPageProps.eventsData?.frEvents || []);
  ...
  return (
    <div className="container">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h1>Merit Bar Application - Civic Service </h1>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          <table className="legend-table">
            <tr>
              <td className="no-wrap">Project:</td>
              <td>
                title of fundraising activity conducted/participated by the
                member
              </td>
            </tr>
            <tr>
              <td>Date:</td>
              <td>date of fundraising activities</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Location:</td>
              <td>where the fundraising activity was held</td>
            </tr>
          </table>
        </div>

        ...
        <div className="col-md-6 justify-content-center">
          ...
          <div className="row" style={{ marginLeft: "70px" }}>
            <p className="text-center" style={{ marginLeft: "-30px" }}>
              Your application is currently being reviewed by the Executive
              Officer.
              <br />
              Please await confirmation for you to proceed with petitioning.
            </p>
            ...
            >
              <Link to="/">
                <button
                  ...
                  style={{ backgroundColor: "#261D82" }}
                >
                  FOLLOW UP WITH EXECUTIVE OFFICER
                </button>
              </Link>
            </div>
          </div>

...
function MemberCircular() {
	...
	const handleCircularClick = (circular) => {
		window.location.href = `/membercircular2/${memberId}/${circular._id}`;
	};
			...
			<div className="row">
				<div className="col-md-3">
					...
					<div className="text-start" style={{ marginLeft: "100px" }}>
						...
						<br />
						<button className="btn-text" type="button" style={{ border: "0" }} onClick={() => {window.location.href = `/inbox/${memberId}`}} >
							<span>

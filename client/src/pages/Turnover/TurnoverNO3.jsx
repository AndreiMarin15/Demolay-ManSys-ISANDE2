      ...
      <div className="container">
         ...
         <div className="row">
            ...
            <div className="col-md-6">
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="standardbearer" className="col-form-label text-left">
                        Standard Bearer:
                     </label>
                  </div>
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="1stpreceptor" className="col-form-label text-left">
                        1st Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="2ndpreceptor" className="col-form-label text-left">
                        2nd Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="3rdpreceptor" className="col-form-label text-left">
                        3rd Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="4thpreceptor" className="col-form-label text-left">
                        4th Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
            ...
            <div className="col-md-6">
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="5thpreceptor" className="col-form-label text-left">
                        5th Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="6thpreceptor" className="col-form-label text-left">
                        6th Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="7thpreceptor" className="col-form-label text-left">
                        7th Preceptor:
                     </label>
                  </div>
                  <div className="col-md-8">

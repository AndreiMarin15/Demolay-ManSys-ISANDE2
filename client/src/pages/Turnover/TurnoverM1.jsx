         ...
         <div className="row">
            ...
            <div className="col-md-6">
               <div className="row align-items-center mt-3">
                  ...
                  <div className="col-md-8">
                     <input type="text" className="form-control readonly-input" value="Edwardo Rafael" readOnly />
                  </div>
               </div>
               ...
               <div className="row align-items-center mt-3">
                  ...
                  <div className="col-md-8">
                     <input type="text" className="form-control readonly-input" value="Chapter Scribe" readOnly />
                  </div>
               </div>
            </div>
            ...
            <div className="col-md-6">
               <div className="row align-items-center mt-3">
                  ...
                  <div className="col-md-8">
                     <input type="text" className="form-control readonly-input" value="Jonathan Que" readOnly />
                  </div>
               </div>

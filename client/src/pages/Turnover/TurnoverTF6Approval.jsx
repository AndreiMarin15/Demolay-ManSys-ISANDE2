      ...
      <div className="row">
         ...
         <div className="col-md-4">
            ...
            <div className="col-md-4">
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="statuscouncilor" className="col-form-label text-left">
                        Status:
                     </label>
                  </div>
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="statusscribe" className="col-form-label text-left">
                        Status:
                     </label>
                  </div>
                  <div className="col-md-8">
            ...
            <div className="col-md-4">
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="datesignedcouncilor" className="col-form-label text-left">
                           Date Signed:
                     </label>
                  </div>
                  <div className="col-md-8">
               ...
               <div className="row align-items-center mt-3">
                  <div className="col-md-4">
                     <label htmlFor="datesignedscribe" className="col-form-label text-left">
                           Date Signed:
                     </label>
                  </div>
                  <div className="col-md-8">

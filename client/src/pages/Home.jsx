		...
		<div id="homelogo">
			...
			<div id="homechild">
				<div class="widget-container">
					<p>
						For more than one hundred years, DeMolay has helped boys become men of outstanding character, through
						dedicated mentorships and unique, hands-on life-skill programs.
					</p>{" "}
				</div>
